    ...
    <div class="card shadow-lg">
        <div class="card-header pb-0 pt-3">
            ...
            <div class="float-start">
                <h5 class="mt-3 mb-0">RPTRA CEMPAKA Configurator</h5>
...
<script src='<?= base_url('assets'); ?>/js/calender/main.js'> </script>
...
<script>
    console.log('<?= $this->M_rptra->data_pengunjung(); ?>');
    ...
    new Chart(ctx2, {
        ...
        data: {
            labels: [
                <?php
                for ($m = 1; $m <= 12; $m++) :
                    $bulan = date('M', mktime(0, 0, 0, $m, 1, date('Y')));
                ?> "<?= $bulan; ?>",
                <?php endfor; ?>
            ],
            datasets: [{
                ...
                fill: true,
                data: <?= $this->M_rptra->data_pengunjung(); ?>,
                maxBarThickness: 6
