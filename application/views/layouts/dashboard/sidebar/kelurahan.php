<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link text-white <?= cek_active('kelurahan/home'); ?>" href="<?= base_url('admin/home'); ?>">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" class="nav-link text-white <?= base_url('kelurahan/home/absensi'); ?>" href="#absensi" role="button">
                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <div class="collapse" id="absensi">
                    ...
                    <ul class="nav">
                        <?php foreach ($rptra as $rp) : ?>
                            <li class="nav-item">
                                <a href="<?= base_url('kelurahan/home/absensi/' . $rp->ID_rptra); ?>" class="nav-link text-white <?= cek_active('absensi/' . $rp->ID_rptra); ?>">
                                    <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
